...
//function darkmode will give the page darker colors when flicking the button
function darkmode() {
    ...
    //when flicking the button in the top right corner of the page the class darkmode22 will be added/deleted on the header.
    const header = document.getElementById('header');
    header.classList.toggle('darkmode22');
